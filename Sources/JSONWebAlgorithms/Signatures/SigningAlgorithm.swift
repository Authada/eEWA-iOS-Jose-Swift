...
public enum SigningAlgorithm: String, Codable {
    ...
    case DVSP256SHA256HS256 = "DVS-P256-SHA256-HS256"
    case DVSP384SHA256HS256 = "DVS-P384-SHA256-HS256"
    case DVSP512SHA256HS256 = "DVS-P512-SHA256-HS256"
    ...
    public var cryptoSigner: Signer? {
        switch self {
        case .HS256, .DVSP256SHA256HS256, .DVSP384SHA256HS256, .DVSP512SHA256HS256:
            return HS256Signer()
        case .HS384:
            return HS384Signer()
        case .HS512:
